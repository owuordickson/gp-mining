...
if __name__ == "__main__":
    ...
    result_json = mine_obj1.discover(target_col=1, transformations='all', search_algorithm='ga', max_iteration=10, eval_mode=True, compute_causality=False)  # TGRAANK-AMI
    print(f"{result_json}\n")
    start = time.time()
